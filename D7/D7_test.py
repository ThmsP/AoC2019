...
def test_main_loop_pmode_jump2():
  a = amplifier(1, 0, [3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9])
  assert a.amplify() == 1
  # assert main_loop([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], 1) == 1

def test_main_loop_large_below():
  a = amplifier(7, 0, [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99])
...
def test_main_loop_large_equal():
  a = amplifier(8, 0, [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99])
...
def test_main_loop_large_bigger():
  a = amplifier(9, 0, [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99])
